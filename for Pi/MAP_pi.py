...
MAP_LAT_TOP, MAP_LON_LEFT     = 36.51474, 127.31916
MAP_LAT_BOTTOM, MAP_LON_RIGHT = 36.40208, 127.49629
...
When you capture map image, 10 pixels per 1 kilometers is recommended resolution
...
def draw_MAP(lat, lon, yaw, sats, course, speed):
